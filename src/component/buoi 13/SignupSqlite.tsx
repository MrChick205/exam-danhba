...
import { addUser } from './database'; // Import hàm thêm user
...
const SignupSqlite = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput placeholder="Tên đăng nhập" style={styles.input} onChangeText={setUsername} value={username} />
      <TextInput placeholder="Mật khẩu" style={styles.input} secureTextEntry onChangeText={setPassword} value={password} />
